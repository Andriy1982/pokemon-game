...
function App() {
  return (
    <>
      ...
      <Layout id={'firstLayout'} urlBg={bg1} title={'Layout_1'}>
        <p>
      ...
      <Layout id={'SecondLayout'} colorBg="purple" title={'Layout_2'}>
        <p>
          {' '}
          In the game two players face off against one another, one side playing
          as "blue", the other as "red" on a 3x3 grid. Each player has five
      ...
      <Layout id={'ThirdLayout'} urlBg={bg2} title={'Layout_3'}>
        <p>
          {' '}
          In the game two players face off against one another, one side playing
          as "blue", the other as "red" on a 3x3 grid. Each player has five
      ...
      <div className={style.flex}>
        {pokemon.map(({ values, name, img, id, type }) => (
          <PokemonCard
            key={id}
            values={values}
            name={name}
